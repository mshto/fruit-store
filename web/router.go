...
import (
	...
	"github.com/mshto/fruit-store/backend/authentication"
	"github.com/mshto/fruit-store/backend/cache"
	"github.com/mshto/fruit-store/backend/config"
	"github.com/mshto/fruit-store/backend/repository"
	"github.com/mshto/fruit-store/backend/web/auth"
	"github.com/mshto/fruit-store/backend/web/middleware"
	"github.com/mshto/fruit-store/backend/web/product"
